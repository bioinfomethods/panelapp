...
class RedirectsTests(TestCase):
    ...
    def test_view_panel(self):
        res = self.client.get(
            "/crowdsourcing/PanelApp/EditPanel/558aa423bb5a16630e15b63c"
        )
        self.assertEqual(res.status_code, 301)

    def test_view_panel_gene(self):
        res = self.client.get(
            "/crowdsourcing/PanelApp/GeneReview/558aa423bb5a16630e15b63c/NTRK1"
        )
        self.assertEqual(res.status_code, 301)
    ...
    def test_specific_versions(self):
        ...
        res = self.client.get(
            "/crowdsourcing/WebServices/get_panel/{}?version=0.0".format(gpes.panel.id)
        )
