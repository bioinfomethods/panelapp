...
from .viewsets import GeneReviewViewSet
...
# Gene review endpoint (POST only)
gene_reviews_router = routers.NestedSimpleRouter(genes_router, r"genes", lookup="gene")
gene_reviews_router.register(
    r"reviews", GeneReviewViewSet, basename="panel-gene-reviews"
)
...
urlpatterns = [
    ...
    path("", include(gene_reviews_router.urls)),
